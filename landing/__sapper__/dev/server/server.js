...
const global$1 = globalThis || window || global$1;
...
async function setLocale(locale) {
  ...
  global$1.localStorage && global$1.localStorage.setItem(KEY, locale);
}

if (!!global$1.localStorage) {
  const initialLanguage = global$1.localStorage.getItem(KEY);
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<header class="${"svelte-pp14cf"}"><div class="${"container svelte-pp14cf"}"><div class="${"segment main svelte-pp14cf"}"><a class="${"home svelte-pp14cf"}" href="${"/"}"><img class="${"logo svelte-pp14cf"}" src="${"/images/Logo.svg"}" alt="${"medlibra"}"></a>

      <div class="${"language text-secondary svelte-pp14cf"}" href="${"/"}" tabindex="${"0"}"><div class="${"language-overlay svelte-pp14cf"}" tabindex="${"0"}"></div>
        <span class="${"svelte-pp14cf"}">${escape($localization.currentLanguage)}</span>
        ${validate_component(Arrow, "Arrow").$$render($$result, {}, {}, {})}
        <div class="${"language-select svelte-pp14cf"}" tabindex="${"0"}">${each($localization.languages, language => `<div class="${"svelte-pp14cf"}">${escape(language.name)}
            </div>`)}</div></div></div>

    <div class="${"segment menu svelte-pp14cf"}">${each(menuItems, item => `<a class="${[
		"text-inactive svelte-pp14cf",
		item.link === `#${currentObservedItem}` ? "active" : ""
	].join(" ").trim()}"${add_attribute("href", item.link, 0)}>${escape(item.title)}
        </a>`)}</div></div></header>`;
});
...
const css$1 = {
	code: ".background.svelte-1ga20bz.svelte-1ga20bz{top:0;left:0;position:absolute;width:100%;height:100%;overflow:hidden;pointer-events:none}.background.svelte-1ga20bz .dark.svelte-1ga20bz{transform:translateY(-48px)}.background.svelte-1ga20bz .light.svelte-1ga20bz{transform:translateY(48px)}.background.mounted.svelte-1ga20bz img.svelte-1ga20bz{transform:translateY(0);opacity:1}img.svelte-1ga20bz.svelte-1ga20bz{position:absolute;opacity:0;transition:all 600ms}@media screen and (max-width: 359px){img.svelte-1ga20bz.svelte-1ga20bz{width:360px}.light.svelte-1ga20bz.svelte-1ga20bz{left:96px;top:464px}.dark.svelte-1ga20bz.svelte-1ga20bz{left:160px;top:380px}}@media screen and (min-width: 360px) and (max-width: 767px){img.svelte-1ga20bz.svelte-1ga20bz{width:100%}.light.svelte-1ga20bz.svelte-1ga20bz{top:452px;left:0}.dark.svelte-1ga20bz.svelte-1ga20bz{top:364px;left:64px}}@media screen and (min-width: 768px){img.svelte-1ga20bz.svelte-1ga20bz{height:600px}.dark.svelte-1ga20bz.svelte-1ga20bz{top:0;left:calc(50% + 114px)}.light.svelte-1ga20bz.svelte-1ga20bz{left:50%;top:272px}}",
...
const Background = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${["background svelte-1ga20bz", mounted ? "mounted" : ""].join(" ").trim()}"><img class="${"light svelte-1ga20bz"}" src="${"/images/light.png"}" alt="${"light"}">
  <img class="${"dark svelte-1ga20bz"}" src="${"/images/dark.png"}" alt="${"dark"}"></div>`;
});

/* src/components/Download.svelte generated by Svelte v3.21.0 */

const css$2 = {
	code: "svg.svelte-8a2ssr.svelte-8a2ssr,img.svelte-8a2ssr.svelte-8a2ssr{opacity:1}h1.svelte-8a2ssr.svelte-8a2ssr{padding-bottom:64px}h3.svelte-8a2ssr.svelte-8a2ssr{padding-bottom:32px}.container.svelte-8a2ssr.svelte-8a2ssr{display:flex;flex-direction:column}.download-buttons.svelte-8a2ssr.svelte-8a2ssr{display:flex}.download-buttons.svelte-8a2ssr a.svelte-8a2ssr{width:196px}.download-buttons.svelte-8a2ssr a.svelte-8a2ssr:not(:nth-last-child(1)){margin-right:32px}.download-buttons.svelte-8a2ssr a.svelte-8a2ssr{padding:20px 0;padding-left:16px;position:relative;border:none;outline:0;background:transparent;width:196px;display:flex;text-decoration:none;box-sizing:border-box}.download-buttons.svelte-8a2ssr a .border.svelte-8a2ssr{position:absolute;width:100%;height:100%;top:0;left:0}.download-buttons.svelte-8a2ssr a .content.svelte-8a2ssr{display:flex;align-items:center;justify-content:space-between;width:100%}.download-buttons.svelte-8a2ssr a .text-content.svelte-8a2ssr{width:100%;display:flex;justify-content:center}.text-accent.svelte-8a2ssr.svelte-8a2ssr{text-align:center;width:100%}@media screen and (max-width: 359px){.download-buttons.svelte-8a2ssr.svelte-8a2ssr{flex-direction:column}.download-buttons.svelte-8a2ssr a.svelte-8a2ssr:nth-child(1){margin-bottom:26px}}@media screen and (max-width: 767px){h1.svelte-8a2ssr.svelte-8a2ssr{max-width:328px;padding-bottom:32px}.download-buttons.svelte-8a2ssr a.svelte-8a2ssr{width:156px}.container.svelte-8a2ssr.svelte-8a2ssr{height:572px;padding-top:32px}}@media screen and (max-width: 767px){h1.svelte-8a2ssr.svelte-8a2ssr{max-width:328px}}@media screen and (min-width: 1280px){h1.svelte-8a2ssr.svelte-8a2ssr{max-width:876px}}@media screen and (min-width: 768px) and (max-width: 1279px){h1.svelte-8a2ssr.svelte-8a2ssr{max-width:650px}.container.svelte-8a2ssr.svelte-8a2ssr{height:656px;justify-content:center}}@media screen and (min-width: 1280px){.container.svelte-8a2ssr.svelte-8a2ssr{height:704px;justify-content:center}}@media screen and (min-width: 768px){h1.svelte-8a2ssr.svelte-8a2ssr{padding-bottom:64px}}",
	map: "{\"version\":3,\"file\":\"Download.svelte\",\"sources\":[\"Download.svelte\"],\"sourcesContent\":[\"<script>\\n  import { localization } from '../localization';\\n</script>\\n\\n<style>\\n  svg,\\n  img {\\n    opacity: 1;\\n  }\\n\\n  h1 {\\n    padding-bottom: 64px;\\n  }\\n\\n  h3 {\\n    padding-bottom: 32px;\\n  }\\n\\n  .container {\\n    display: flex;\\n    flex-direction: column;\\n  }\\n\\n  .download-buttons {\\n    display: flex;\\n  }\\n\\n  .download-buttons a {\\n    width: 196px;\\n  }\\n\\n  .download-buttons a:not(:nth-last-child(1)) {\\n    margin-right: 32px;\\n  }\\n\\n  .download-buttons a {\\n    padding: 20px 0;\\n    padding-left: 16px;\\n    position: relative;\\n    border: none;\\n    outline: 0;\\n    background: transparent;\\n    width: 196px;\\n    display: flex;\\n    text-decoration: none;\\n    box-sizing: border-box;\\n  }\\n\\n  .download-buttons a .border {\\n    position: absolute;\\n    width: 100%;\\n    height: 100%;\\n    top: 0;\\n    left: 0;\\n  }\\n\\n  .download-buttons a .content {\\n    display: flex;\\n    align-items: center;\\n    justify-content: space-between;\\n    width: 100%;\\n  }\\n\\n  .download-buttons a .text-content {\\n    width: 100%;\\n    display: flex;\\n    justify-content: center;\\n  }\\n\\n  .text-accent {\\n    text-align: center;\\n    width: 100%;\\n  }\\n\\n  @media screen and (max-width: 359px) {\\n    .download-buttons {\\n      flex-direction: column;\\n    }\\n\\n    .download-buttons a:nth-child(1) {\\n      margin-bottom: 26px;\\n    }\\n  }\\n\\n  @media screen and (max-width: 767px) {\\n    h1 {\\n      max-width: 328px;\\n      padding-bottom: 32px;\\n    }\\n\\n    .download-buttons a {\\n      width: 156px;\\n    }\\n\\n    .container {\\n      height: 572px;\\n      padding-top: 32px;\\n    }\\n  }\\n\\n  @media screen and (max-width: 767px) {\\n    h1 {\\n      max-width: 328px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1280px) {\\n    h1 {\\n      max-width: 876px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 768px) and (max-width: 1279px) {\\n    h1 {\\n      max-width: 650px;\\n    }\\n\\n    .container {\\n      height: 656px;\\n      justify-content: center;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1280px) {\\n    .container {\\n      height: 704px;\\n      justify-content: center;\\n    }\\n  }\\n\\n  @media screen and (min-width: 768px) {\\n    h1 {\\n      padding-bottom: 64px;\\n    }\\n  }\\n</style>\\n\\n<div class=\\\"path container\\\" id=\\\"download\\\">\\n  <h1 class=\\\"text-primary\\\">\\n    {$localization.download.title}\\n    <br />\\n    <br />\\n    {$localization.download.titleDescription}\\n  </h1>\\n\\n  <h3 class=\\\"text-secondary\\\">{$localization.download.downloadFree}</h3>\\n\\n  <div class=\\\"download-buttons\\\">\\n    <a href=\\\"/\\\">\\n      <div class=\\\"border\\\">\\n        <svg width=\\\"100%\\\" height=\\\"100%\\\">\\n          <defs>\\n            <linearGradient\\n              id=\\\"gradient-appstore\\\"\\n              x1=\\\"0%\\\"\\n              y1=\\\"0%\\\"\\n              x2=\\\"100%\\\"\\n              y2=\\\"0%\\\">\\n              <stop offset=\\\"0%\\\" stop-color=\\\"#1AC6FB\\\" />\\n              <stop offset=\\\"100%\\\" stop-color=\\\"#1C72F0\\\" />\\n            </linearGradient>\\n          </defs>\\n          <rect\\n            x=\\\"1\\\"\\n            y=\\\"1\\\"\\n            rx=\\\"16\\\"\\n            ry=\\\"16\\\"\\n            width=\\\"calc(100% - 2px)\\\"\\n            fill=\\\"rgba(254, 251, 246, 0.05)\\\"\\n            height=\\\"calc(100% - 2px)\\\"\\n            stroke=\\\"url(#gradient-appstore)\\\"\\n            stroke-width=\\\"2\\\" />\\n        </svg>\\n      </div>\\n\\n      <div class=\\\"content\\\">\\n        <img src=\\\"/images/appstore.svg\\\" alt=\\\"app store\\\" />\\n        <div class=\\\"text-content\\\">\\n          <span class=\\\"text-accent text-primary\\\">AppStore</span>\\n        </div>\\n      </div>\\n    </a>\\n\\n    <a href=\\\"/\\\">\\n      <div class=\\\"border\\\">\\n        <svg width=\\\"100%\\\" height=\\\"100%\\\">\\n          <defs>\\n            <linearGradient\\n              id=\\\"gradient-playmarket\\\"\\n              x1=\\\"0%\\\"\\n              y1=\\\"0%\\\"\\n              x2=\\\"100%\\\"\\n              y2=\\\"0%\\\">\\n              <stop offset=\\\"0%\\\" stop-color=\\\"#00E0FF\\\" />\\n              <stop offset=\\\"33%\\\" stop-color=\\\"#00F085\\\" />\\n              <stop offset=\\\"66%\\\" stop-color=\\\"#FFE300\\\" />\\n              <stop offset=\\\"100%\\\" stop-color=\\\"#FF4E54\\\" />\\n            </linearGradient>\\n          </defs>\\n          <rect\\n            x=\\\"1\\\"\\n            y=\\\"1\\\"\\n            rx=\\\"16\\\"\\n            ry=\\\"16\\\"\\n            width=\\\"calc(100% - 2px)\\\"\\n            fill=\\\"rgba(254, 251, 246, 0.05)\\\"\\n            height=\\\"calc(100% - 2px)\\\"\\n            stroke=\\\"url(#gradient-playmarket)\\\"\\n            stroke-width=\\\"2\\\" />\\n        </svg>\\n      </div>\\n\\n      <div class=\\\"content\\\">\\n        <img src=\\\"/images/playstore.svg\\\" alt=\\\"play market\\\" />\\n        <div class=\\\"text-content\\\">\\n          <span class=\\\"text-accent text-primary\\\">PlayMarket</span>\\n        </div>\\n      </div>\\n    </a>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAKE,+BAAG,CACH,GAAG,4BAAC,CAAC,AACH,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,cAAc,CAAE,IAAI,AACtB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,cAAc,CAAE,IAAI,AACtB,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,AACxB,CAAC,AAED,iBAAiB,4BAAC,CAAC,AACjB,OAAO,CAAE,IAAI,AACf,CAAC,AAED,+BAAiB,CAAC,CAAC,cAAC,CAAC,AACnB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,+BAAiB,CAAC,eAAC,KAAK,gBAAgB,CAAC,CAAC,CAAC,AAAC,CAAC,AAC3C,YAAY,CAAE,IAAI,AACpB,CAAC,AAED,+BAAiB,CAAC,CAAC,cAAC,CAAC,AACnB,OAAO,CAAE,IAAI,CAAC,CAAC,CACf,YAAY,CAAE,IAAI,CAClB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,IAAI,CACrB,UAAU,CAAE,UAAU,AACxB,CAAC,AAED,+BAAiB,CAAC,CAAC,CAAC,OAAO,cAAC,CAAC,AAC3B,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,AACT,CAAC,AAED,+BAAiB,CAAC,CAAC,CAAC,QAAQ,cAAC,CAAC,AAC5B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAC9B,KAAK,CAAE,IAAI,AACb,CAAC,AAED,+BAAiB,CAAC,CAAC,CAAC,aAAa,cAAC,CAAC,AACjC,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,YAAY,4BAAC,CAAC,AACZ,UAAU,CAAE,MAAM,CAClB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,iBAAiB,4BAAC,CAAC,AACjB,cAAc,CAAE,MAAM,AACxB,CAAC,AAED,+BAAiB,CAAC,eAAC,WAAW,CAAC,CAAC,AAAC,CAAC,AAChC,aAAa,CAAE,IAAI,AACrB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,GAAG,EAAE,CAAC,AAAC,CAAC,AACpC,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,IAAI,AACtB,CAAC,AAED,+BAAiB,CAAC,CAAC,cAAC,CAAC,AACnB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,AAClB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,AAClB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC5D,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,MAAM,CAAE,KAAK,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,UAAU,4BAAC,CAAC,AACV,MAAM,CAAE,KAAK,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,EAAE,4BAAC,CAAC,AACF,cAAc,CAAE,IAAI,AACtB,CAAC,AACH,CAAC\"}"
};
...
const Download = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"path container svelte-8a2ssr"}" id="${"download"}"><h1 class="${"text-primary svelte-8a2ssr"}">${escape($localization.download.title)}
    <br>
    <br>
    ${escape($localization.download.titleDescription)}</h1>

  <h3 class="${"text-secondary svelte-8a2ssr"}">${escape($localization.download.downloadFree)}</h3>

  <div class="${"download-buttons svelte-8a2ssr"}"><a href="${"/"}" class="${"svelte-8a2ssr"}"><div class="${"border svelte-8a2ssr"}"><svg width="${"100%"}" height="${"100%"}" class="${"svelte-8a2ssr"}"><defs><linearGradient id="${"gradient-appstore"}" x1="${"0%"}" y1="${"0%"}" x2="${"100%"}" y2="${"0%"}"><stop offset="${"0%"}" stop-color="${"#1AC6FB"}"></stop><stop offset="${"100%"}" stop-color="${"#1C72F0"}"></stop></linearGradient></defs><rect x="${"1"}" y="${"1"}" rx="${"16"}" ry="${"16"}" width="${"calc(100% - 2px)"}" fill="${"rgba(254, 251, 246, 0.05)"}" height="${"calc(100% - 2px)"}" stroke="${"url(#gradient-appstore)"}" stroke-width="${"2"}"></rect></svg></div>

      <div class="${"content svelte-8a2ssr"}"><img src="${"/images/appstore.svg"}" alt="${"app store"}" class="${"svelte-8a2ssr"}">
        <div class="${"text-content svelte-8a2ssr"}"><span class="${"text-accent text-primary svelte-8a2ssr"}">AppStore</span></div></div></a>

    <a href="${"/"}" class="${"svelte-8a2ssr"}"><div class="${"border svelte-8a2ssr"}"><svg width="${"100%"}" height="${"100%"}" class="${"svelte-8a2ssr"}"><defs><linearGradient id="${"gradient-playmarket"}" x1="${"0%"}" y1="${"0%"}" x2="${"100%"}" y2="${"0%"}"><stop offset="${"0%"}" stop-color="${"#00E0FF"}"></stop><stop offset="${"33%"}" stop-color="${"#00F085"}"></stop><stop offset="${"66%"}" stop-color="${"#FFE300"}"></stop><stop offset="${"100%"}" stop-color="${"#FF4E54"}"></stop></linearGradient></defs><rect x="${"1"}" y="${"1"}" rx="${"16"}" ry="${"16"}" width="${"calc(100% - 2px)"}" fill="${"rgba(254, 251, 246, 0.05)"}" height="${"calc(100% - 2px)"}" stroke="${"url(#gradient-playmarket)"}" stroke-width="${"2"}"></rect></svg></div>

      <div class="${"content svelte-8a2ssr"}"><img src="${"/images/playstore.svg"}" alt="${"play market"}" class="${"svelte-8a2ssr"}">
        <div class="${"text-content svelte-8a2ssr"}"><span class="${"text-accent text-primary svelte-8a2ssr"}">PlayMarket</span></div></div></a></div></div>`;
});

/* src/components/Advantages.svelte generated by Svelte v3.21.0 */

const css$3 = {
	code: ".overview.svelte-15otg7s.svelte-15otg7s{position:relative;display:flex;flex-wrap:wrap;justify-content:space-between}.overview-wrapper.svelte-15otg7s.svelte-15otg7s{width:100%;overflow:hidden}.overview.container.svelte-15otg7s.svelte-15otg7s{padding:0}.overview.svelte-15otg7s h2.svelte-15otg7s,.overview.svelte-15otg7s h3.svelte-15otg7s{white-space:pre-line;text-align:center}.overview.svelte-15otg7s h2.svelte-15otg7s{padding-bottom:8px}@media screen and (max-width: 767px){.overview.svelte-15otg7s.svelte-15otg7s{height:464px;align-items:center}.overview.svelte-15otg7s .item.svelte-15otg7s{width:50%}}@media screen and (min-width: 767px) and (max-width: 1023px){.overview.svelte-15otg7s.svelte-15otg7s{height:344px;align-items:center}.overview.container.svelte-15otg7s.svelte-15otg7s{padding:0 12px}}@media screen and (min-width: 1024px){.overview.svelte-15otg7s.svelte-15otg7s:before,.overview.svelte-15otg7s.svelte-15otg7s:after{content:'';position:absolute;width:100%;left:-100%;height:4px;margin-top:-2px;background:rgba(254, 251, 246, 0.15);border-radius:2px;top:50%}.overview.svelte-15otg7s.svelte-15otg7s:before{left:-100%}.overview.svelte-15otg7s.svelte-15otg7s:after{left:100%}.overview.svelte-15otg7s .item.svelte-15otg7s{background:rgba(254, 251, 246, 0.105);border:4px solid rgba(254, 251, 246, 0.105);border-radius:32px;display:flex;flex-direction:column;justify-content:center}}@media screen and (min-width: 1024px) and (max-width: 1279px){.overview.svelte-15otg7s.svelte-15otg7s{height:344px;align-items:center}.overview.svelte-15otg7s .item.svelte-15otg7s{width:196px;height:200px}}@media screen and (min-width: 1280px) and (max-width: 1919px){.overview.svelte-15otg7s.svelte-15otg7s{height:472px;align-items:center}.overview.svelte-15otg7s .item.svelte-15otg7s{width:256px;height:256px}}@media screen and (min-width: 1920px){.overview.svelte-15otg7s.svelte-15otg7s{height:472px;align-items:center}.overview.svelte-15otg7s .item.svelte-15otg7s{width:310px;height:256px}}.infographics.svelte-15otg7s.svelte-15otg7s{position:relative;display:flex;align-items:center}.infographics.svelte-15otg7s img.svelte-15otg7s{transition:all 1.5s}.infographics.svelte-15otg7s.svelte-15otg7s:not(:nth-last-child(1)):after{content:'';position:absolute;bottom:0;left:0;margin:0 auto;width:50%;border-radius:2px;height:4px;background:rgba(254, 251, 246, 0.15);margin-left:25%}.infographics.svelte-15otg7s.svelte-15otg7s:nth-child(2n){flex-direction:row-reverse}.infographics.svelte-15otg7s>.svelte-15otg7s{width:50%}@media screen and (max-width: 359px){.infographics.svelte-15otg7s h2.svelte-15otg7s{padding-bottom:8px}}@media screen and (min-width: 360px) and (max-width: 1279px){.infographics.svelte-15otg7s h2.svelte-15otg7s{padding-bottom:32px}}@media screen and (max-width: 767px){.infographics.svelte-15otg7s img.svelte-15otg7s{opacity:0;transform:translateY(-64px)}.infographics.svelte-15otg7s.svelte-15otg7s img.appear{opacity:1;transform:translateY(0)}.infographics.svelte-15otg7s.svelte-15otg7s{padding:32px 0}.infographics.svelte-15otg7s.svelte-15otg7s:nth-child(n){flex-direction:column;align-items:center}.infographics.svelte-15otg7s:nth-child(n) .svelte-15otg7s{width:100%}.infographics.svelte-15otg7s img.svelte-15otg7s{margin-bottom:32px}}@media screen and (min-width: 768px){.infographics.svelte-15otg7s img.svelte-15otg7s{transition:all 1s}.infographics.svelte-15otg7s img.svelte-15otg7s{opacity:0}.infographics.svelte-15otg7s:nth-child(2n) img.svelte-15otg7s{transform:translateX(64px)}.infographics.svelte-15otg7s:nth-child(2n + 1) img.svelte-15otg7s{transform:translateX(-64px)}.infographics.svelte-15otg7s.svelte-15otg7s img.appear{opacity:1;transform:translateX(0)}}@media screen and (min-width: 768px) and (max-width: 1279px){.infographics.svelte-15otg7s.svelte-15otg7s{height:352px}h3.svelte-15otg7s.svelte-15otg7s{font-size:24px;line-height:32px}}@media screen and (min-width: 1280px){.infographics.svelte-15otg7s.svelte-15otg7s{height:448px}.infographics.svelte-15otg7s h2.svelte-15otg7s{padding-bottom:40px}h3.svelte-15otg7s.svelte-15otg7s{font-size:32px;line-height:48px}}",
	map: "{\"version\":3,\"file\":\"Advantages.svelte\",\"sources\":[\"Advantages.svelte\"],\"sourcesContent\":[\"<script>\\n  import { localization } from '../localization';\\n\\n  function appear(node) {\\n    const io = new IntersectionObserver(\\n      ([entry]) => {\\n        if (!entry.isIntersecting) return;\\n        node.classList.add('appear');\\n        io.unobserve(node);\\n      },\\n      {\\n        threshold: 0.2,\\n      },\\n    );\\n\\n    io.observe(node);\\n  }\\n</script>\\n\\n<style>\\n  /* overview */\\n  .overview {\\n    position: relative;\\n    display: flex;\\n    flex-wrap: wrap;\\n    justify-content: space-between;\\n  }\\n\\n  .overview-wrapper {\\n    width: 100%;\\n    overflow: hidden;\\n  }\\n\\n  .overview.container {\\n    padding: 0;\\n  }\\n\\n  .overview h2,\\n  .overview h3 {\\n    white-space: pre-line;\\n    text-align: center;\\n  }\\n\\n  .overview h2 {\\n    padding-bottom: 8px;\\n  }\\n\\n  @media screen and (max-width: 767px) {\\n    .overview {\\n      height: 464px;\\n      align-items: center;\\n    }\\n\\n    .overview .item {\\n      width: 50%;\\n    }\\n  }\\n\\n  @media screen and (min-width: 767px) and (max-width: 1023px) {\\n    .overview {\\n      height: 344px;\\n      align-items: center;\\n    }\\n\\n    .overview.container {\\n      /* max-width: 100%; */\\n      padding: 0 12px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1024px) {\\n    .overview:before,\\n    .overview:after {\\n      content: '';\\n      position: absolute;\\n      width: 100%;\\n      left: -100%;\\n      height: 4px;\\n      margin-top: -2px;\\n      background: rgba(254, 251, 246, 0.15);\\n      border-radius: 2px;\\n      top: 50%;\\n    }\\n\\n    .overview:before {\\n      left: -100%;\\n    }\\n\\n    .overview:after {\\n      left: 100%;\\n    }\\n\\n    .overview .item {\\n      background: rgba(254, 251, 246, 0.105);\\n      border: 4px solid rgba(254, 251, 246, 0.105);\\n      border-radius: 32px;\\n      display: flex;\\n      flex-direction: column;\\n      justify-content: center;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1024px) and (max-width: 1279px) {\\n    .overview {\\n      height: 344px;\\n      align-items: center;\\n    }\\n\\n    .overview .item {\\n      width: 196px;\\n      height: 200px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1280px) and (max-width: 1919px) {\\n    .overview {\\n      height: 472px;\\n      align-items: center;\\n    }\\n\\n    .overview .item {\\n      width: 256px;\\n      height: 256px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1920px) {\\n    .overview {\\n      height: 472px;\\n      align-items: center;\\n    }\\n\\n    .overview .item {\\n      width: 310px;\\n      height: 256px;\\n    }\\n  }\\n\\n  /* infographics */\\n  .infographics {\\n    position: relative;\\n    display: flex;\\n    align-items: center;\\n  }\\n\\n  .infographics img {\\n    transition: all 1.5s;\\n  }\\n\\n  .infographics:not(:nth-last-child(1)):after {\\n    content: '';\\n    position: absolute;\\n    bottom: 0;\\n    left: 0;\\n    margin: 0 auto;\\n    width: 50%;\\n    border-radius: 2px;\\n    height: 4px;\\n    background: rgba(254, 251, 246, 0.15);\\n    margin-left: 25%;\\n  }\\n\\n  .infographics:nth-child(2n) {\\n    flex-direction: row-reverse;\\n  }\\n\\n  .infographics > * {\\n    width: 50%;\\n  }\\n\\n  @media screen and (max-width: 359px) {\\n    .infographics h2 {\\n      padding-bottom: 8px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 360px) and (max-width: 1279px) {\\n    .infographics h2 {\\n      padding-bottom: 32px;\\n    }\\n  }\\n\\n  @media screen and (max-width: 767px) {\\n    .infographics img {\\n      opacity: 0;\\n      transform: translateY(-64px);\\n    }\\n\\n    .infographics :global(img.appear) {\\n      opacity: 1;\\n      transform: translateY(0);\\n    }\\n\\n    .infographics {\\n      padding: 32px 0;\\n    }\\n\\n    .infographics:nth-child(n) {\\n      flex-direction: column;\\n      align-items: center;\\n    }\\n\\n    .infographics:nth-child(n) * {\\n      width: 100%;\\n    }\\n\\n    .infographics img {\\n      margin-bottom: 32px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 768px) {\\n    .infographics img {\\n      transition: all 1s;\\n    }\\n\\n    .infographics img {\\n      opacity: 0;\\n    }\\n\\n    .infographics:nth-child(2n) img {\\n      transform: translateX(64px);\\n    }\\n\\n    .infographics:nth-child(2n + 1) img {\\n      transform: translateX(-64px);\\n    }\\n\\n    .infographics :global(img.appear) {\\n      opacity: 1;\\n      transform: translateX(0);\\n    }\\n  }\\n\\n  @media screen and (min-width: 768px) and (max-width: 1279px) {\\n    .infographics {\\n      height: 352px;\\n    }\\n\\n    h3 {\\n      font-size: 24px;\\n      line-height: 32px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1280px) {\\n    .infographics {\\n      height: 448px;\\n    }\\n\\n    .infographics h2 {\\n      padding-bottom: 40px;\\n    }\\n\\n    h3 {\\n      font-size: 32px;\\n      line-height: 48px;\\n    }\\n  }\\n</style>\\n\\n<div class=\\\"path\\\" id=\\\"advantages\\\">\\n  <div class=\\\"overview-wrapper\\\">\\n    <div class=\\\"container overview\\\">\\n      {#each $localization.advantages.overview as overview}\\n        <div class=\\\"item\\\">\\n          <h2 class=\\\"text-primary\\\">{overview.title}</h2>\\n          <h3 class=\\\"text-secondary\\\">{overview.content}</h3>\\n        </div>\\n      {/each}\\n    </div>\\n  </div>\\n\\n  <div class=\\\"container\\\">\\n    {#each $localization.advantages.infographics as infographics, index}\\n      <div class=\\\"infographics\\\">\\n        <img use:appear src=\\\"/images/illustration{index + 1}.svg\\\" alt=\\\"img\\\" />\\n\\n        <div>\\n          <h2 class=\\\"text-primary\\\">{infographics.title}</h2>\\n          <h3 class=\\\"text-secondary\\\">{infographics.content}</h3>\\n        </div>\\n      </div>\\n    {/each}\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAqBE,SAAS,8BAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,eAAe,CAAE,aAAa,AAChC,CAAC,AAED,iBAAiB,8BAAC,CAAC,AACjB,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,AAClB,CAAC,AAED,SAAS,UAAU,8BAAC,CAAC,AACnB,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,wBAAS,CAAC,iBAAE,CACZ,wBAAS,CAAC,EAAE,eAAC,CAAC,AACZ,WAAW,CAAE,QAAQ,CACrB,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,wBAAS,CAAC,EAAE,eAAC,CAAC,AACZ,cAAc,CAAE,GAAG,AACrB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,wBAAS,CAAC,KAAK,eAAC,CAAC,AACf,KAAK,CAAE,GAAG,AACZ,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC5D,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,SAAS,UAAU,8BAAC,CAAC,AAEnB,OAAO,CAAE,CAAC,CAAC,IAAI,AACjB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,uCAAS,OAAO,CAChB,uCAAS,MAAM,AAAC,CAAC,AACf,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,KAAK,CACX,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC,CACrC,aAAa,CAAE,GAAG,CAClB,GAAG,CAAE,GAAG,AACV,CAAC,AAED,uCAAS,OAAO,AAAC,CAAC,AAChB,IAAI,CAAE,KAAK,AACb,CAAC,AAED,uCAAS,MAAM,AAAC,CAAC,AACf,IAAI,CAAE,IAAI,AACZ,CAAC,AAED,wBAAS,CAAC,KAAK,eAAC,CAAC,AACf,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,CACtC,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,CAC5C,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,AACzB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC7D,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,wBAAS,CAAC,KAAK,eAAC,CAAC,AACf,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACf,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC7D,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,wBAAS,CAAC,KAAK,eAAC,CAAC,AACf,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACf,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,SAAS,8BAAC,CAAC,AACT,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,wBAAS,CAAC,KAAK,eAAC,CAAC,AACf,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACf,CAAC,AACH,CAAC,AAGD,aAAa,8BAAC,CAAC,AACb,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,UAAU,CAAE,GAAG,CAAC,IAAI,AACtB,CAAC,AAED,2CAAa,KAAK,gBAAgB,CAAC,CAAC,CAAC,MAAM,AAAC,CAAC,AAC3C,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,GAAG,CACV,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC,CACrC,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,2CAAa,WAAW,EAAE,CAAC,AAAC,CAAC,AAC3B,cAAc,CAAE,WAAW,AAC7B,CAAC,AAED,4BAAa,CAAG,eAAE,CAAC,AACjB,KAAK,CAAE,GAAG,AACZ,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,4BAAa,CAAC,EAAE,eAAC,CAAC,AAChB,cAAc,CAAE,GAAG,AACrB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC5D,4BAAa,CAAC,EAAE,eAAC,CAAC,AAChB,cAAc,CAAE,IAAI,AACtB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,OAAO,CAAE,CAAC,CACV,SAAS,CAAE,WAAW,KAAK,CAAC,AAC9B,CAAC,AAED,2CAAa,CAAC,AAAQ,UAAU,AAAE,CAAC,AACjC,OAAO,CAAE,CAAC,CACV,SAAS,CAAE,WAAW,CAAC,CAAC,AAC1B,CAAC,AAED,aAAa,8BAAC,CAAC,AACb,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AAED,2CAAa,WAAW,CAAC,CAAC,AAAC,CAAC,AAC1B,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,4BAAa,WAAW,CAAC,CAAC,CAAC,eAAE,CAAC,AAC5B,KAAK,CAAE,IAAI,AACb,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,aAAa,CAAE,IAAI,AACrB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,UAAU,CAAE,GAAG,CAAC,EAAE,AACpB,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,4BAAa,IAAI,OAAO,EAAE,CAAC,CAAC,GAAG,eAAC,CAAC,AAC/B,SAAS,CAAE,WAAW,IAAI,CAAC,AAC7B,CAAC,AAED,4BAAa,WAAW,MAAM,CAAC,CAAC,EAAE,CAAC,eAAC,CAAC,AACnC,SAAS,CAAE,WAAW,KAAK,CAAC,AAC9B,CAAC,AAED,2CAAa,CAAC,AAAQ,UAAU,AAAE,CAAC,AACjC,OAAO,CAAE,CAAC,CACV,SAAS,CAAE,WAAW,CAAC,CAAC,AAC1B,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC5D,aAAa,8BAAC,CAAC,AACb,MAAM,CAAE,KAAK,AACf,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,MAAM,MAAM,MAAM,CAAC,AAAC,CAAC,AACrC,aAAa,8BAAC,CAAC,AACb,MAAM,CAAE,KAAK,AACf,CAAC,AAED,4BAAa,CAAC,EAAE,eAAC,CAAC,AAChB,cAAc,CAAE,IAAI,AACtB,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC\"}"
};
...
const Advantages = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"path svelte-15otg7s"}" id="${"advantages"}"><div class="${"overview-wrapper svelte-15otg7s"}"><div class="${"container overview svelte-15otg7s"}">${each($localization.advantages.overview, overview => `<div class="${"item svelte-15otg7s"}"><h2 class="${"text-primary svelte-15otg7s"}">${escape(overview.title)}</h2>
          <h3 class="${"text-secondary svelte-15otg7s"}">${escape(overview.content)}</h3>
        </div>`)}</div></div>

  <div class="${"container"}">${each($localization.advantages.infographics, (infographics, index) => `<div class="${"infographics svelte-15otg7s"}"><img src="${"/images/illustration" + escape(index + 1) + ".svg"}" alt="${"img"}" class="${"svelte-15otg7s"}">

        <div class="${"svelte-15otg7s"}"><h2 class="${"text-primary svelte-15otg7s"}">${escape(infographics.title)}</h2>
          <h3 class="${"text-secondary svelte-15otg7s"}">${escape(infographics.content)}</h3></div>
      </div>`)}</div></div>`;
});
...
const css$4 = {
	code: "h1.svelte-1cvf5qm.svelte-1cvf5qm{padding:32px 0}.row.svelte-1cvf5qm.svelte-1cvf5qm{white-space:pre-line;display:flex}.split.svelte-1cvf5qm.svelte-1cvf5qm{width:32px;height:32px}.row.svelte-1cvf5qm p.svelte-1cvf5qm{flex:1}.container.svelte-1cvf5qm.svelte-1cvf5qm{padding-bottom:32px}@media screen and (max-width: 1279px){.row.svelte-1cvf5qm.svelte-1cvf5qm{flex-direction:column}}@media screen and (min-width: 1024px){h1.svelte-1cvf5qm.svelte-1cvf5qm{padding:72px 0}}@media screen and (min-width: 1024px) and (max-width: 1279px){.container.svelte-1cvf5qm.svelte-1cvf5qm{padding-bottom:56px}}@media screen and (min-width: 1280px) and (max-width: 1919px){.container.svelte-1cvf5qm.svelte-1cvf5qm{padding-bottom:72px}}@media screen and (min-width: 1920px){.container.svelte-1cvf5qm.svelte-1cvf5qm{padding-bottom:104px}}",
	map: "{\"version\":3,\"file\":\"Features.svelte\",\"sources\":[\"Features.svelte\"],\"sourcesContent\":[\"<script>\\n  import { localization } from '../localization';\\n</script>\\n\\n<style>\\n  h1 {\\n    padding: 32px 0;\\n  }\\n\\n  .row {\\n    white-space: pre-line;\\n    display: flex;\\n  }\\n\\n  .split {\\n    width: 32px;\\n    height: 32px;\\n  }\\n\\n  .row p {\\n    flex: 1;\\n  }\\n\\n  .container {\\n    padding-bottom: 32px;\\n  }\\n\\n  @media screen and (max-width: 1279px) {\\n    .row {\\n      flex-direction: column;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1024px) {\\n    h1 {\\n      padding: 72px 0;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1024px) and (max-width: 1279px) {\\n    .container {\\n      padding-bottom: 56px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1280px) and (max-width: 1919px) {\\n    .container {\\n      padding-bottom: 72px;\\n    }\\n  }\\n\\n  @media screen and (min-width: 1920px) {\\n    .container {\\n      padding-bottom: 104px;\\n    }\\n  }\\n</style>\\n\\n<div class=\\\"path container\\\" id=\\\"features\\\">\\n  <h1 class=\\\"text-primary\\\">{$localization.features.title}</h1>\\n\\n  <div class=\\\"row text-secondary\\\">\\n    <p>{$localization.features.content[0]}</p>\\n    <div class=\\\"split\\\" />\\n    <p>{$localization.features.content[1]}</p>\\n  </div>\\n\\n  <h1 class=\\\"text-primary\\\">{$localization.features.testBaseTitle}</h1>\\n\\n  <div class=\\\"row text-secondary\\\">\\n    <p>{$localization.features.testBaseContent[0]}</p>\\n    <div class=\\\"split\\\" />\\n    <p>{$localization.features.testBaseContent[1]}</p>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAKE,EAAE,8BAAC,CAAC,AACF,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AAED,IAAI,8BAAC,CAAC,AACJ,WAAW,CAAE,QAAQ,CACrB,OAAO,CAAE,IAAI,AACf,CAAC,AAED,MAAM,8BAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AAED,mBAAI,CAAC,CAAC,eAAC,CAAC,AACN,IAAI,CAAE,CAAC,AACT,CAAC,AAED,UAAU,8BAAC,CAAC,AACV,cAAc,CAAE,IAAI,AACtB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,IAAI,8BAAC,CAAC,AACJ,cAAc,CAAE,MAAM,AACxB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,EAAE,8BAAC,CAAC,AACF,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC7D,UAAU,8BAAC,CAAC,AACV,cAAc,CAAE,IAAI,AACtB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC7D,UAAU,8BAAC,CAAC,AACV,cAAc,CAAE,IAAI,AACtB,CAAC,AACH,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,UAAU,8BAAC,CAAC,AACV,cAAc,CAAE,KAAK,AACvB,CAAC,AACH,CAAC\"}"
};
...
const Features = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"path container svelte-1cvf5qm"}" id="${"features"}"><h1 class="${"text-primary svelte-1cvf5qm"}">${escape($localization.features.title)}</h1>

  <div class="${"row text-secondary svelte-1cvf5qm"}"><p class="${"svelte-1cvf5qm"}">${escape($localization.features.content[0])}</p>
    <div class="${"split svelte-1cvf5qm"}"></div>
    <p class="${"svelte-1cvf5qm"}">${escape($localization.features.content[1])}</p></div>

  <h1 class="${"text-primary svelte-1cvf5qm"}">${escape($localization.features.testBaseTitle)}</h1>

  <div class="${"row text-secondary svelte-1cvf5qm"}"><p class="${"svelte-1cvf5qm"}">${escape($localization.features.testBaseContent[0])}</p>
    <div class="${"split svelte-1cvf5qm"}"></div>
    <p class="${"svelte-1cvf5qm"}">${escape($localization.features.testBaseContent[1])}</p></div></div>`;
});
...
${($$result.head += `${($$result.title = `<title>Medlibra</title>`, "")}`, "")}`;
});
